        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyGroups_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupToDos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupToDos_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupToDos_ToDos_ToDoId",
                        column: x => x.ToDoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ToDoId = table.Column<int>(type: "int", nullable: false),
                    Assigend = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupToDos_GroupId",
                table: "GroupToDos",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupToDos_ToDoId",
                table: "GroupToDos",
                column: "ToDoId");
